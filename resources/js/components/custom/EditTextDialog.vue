...
import TextInput from './create/TextInput.vue';
    ...
    <Dialog v-model:open="props.isOpen" @update:open="$emit('update:isOpen', $event)">
        <DialogContent>
            ...
            <form @submit.prevent="submit">
                <TextInput v-model="inputValue" label="" :id="props.form_target" class="max-h-[70vh]" @update="inputValue = $event" />
