...
<template>
    <div v-if="!content.competitors" class="flex w-full flex-col">
        <CompetitorCardSkeleton class="w-full" v-for="n in 5" :key="n"></CompetitorCardSkeleton>
    </div>

    <div v-else>
        <CompetitorCard v-for="competitor in content.competitors" :key="competitor.name" :competitor="competitor" />
    </div>
</template>
